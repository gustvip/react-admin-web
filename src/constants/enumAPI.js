...
const API = {
  ...
  */
   ...
   |----------------------------------------------------------------
  */
	administratorAuthEnumDownload: _proxyAPI('/administrator/authEnum/download'), // 权限json下载
	administratorAuthEnumList: _proxyAPI('/administrator/authEnum/list'), // 权限枚举列表
	administratorAuthEnumAdd: _proxyAPI('/administrator/authEnum/add'), // 权限枚举新增
	administratorAuthEnumDelete: _proxyAPI('/administrator/authEnum/delete'), // 权限枚举删除
	administratorAuthEnumUpdate: _proxyAPI('/administrator/authEnum/update'), // 权限枚举更新
