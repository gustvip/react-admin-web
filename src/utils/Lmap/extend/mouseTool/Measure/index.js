...
export default class Measure {
  ...
  _toggleMeasure (choice) {
    ...
    if (choice) {
      ...
      L.DomEvent.on(this._map._container, 'contextmenu', this._preventDefault, this)
      this._clickCount = 0
      ...
      L.DomEvent.off(this._map._container, 'contextmenu', this._preventDefault, this)
  ...
  _clicked (e) {
    const L = this.L
    // console.log(this._map.hasLayer(this._pointLayer), this._pointLayer)
    if (!this._pointLayer || !this._polylineLayer) return false
  ...
  _moving (e) {
    ...
    if (this._clickedLatLong) {
      ...
      if (this._clickCount > 1) {
        text = '<b>' + '距离:' + '</b>&nbsp;' + this._addedLength.toFixed(this.options.lengthUnit.decimal) + '&nbsp;' + this.options.lengthUnit.display + '<br><div class="plus-length">(+' +
